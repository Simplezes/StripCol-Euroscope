...
private:
    ...
    bool enableClearanceAndSquawk = true;
...
public:
    ...
    void GetPointTime(const std::string &callsign, const std::string &points, std::function<void(bool, const std::string &)> callback);
